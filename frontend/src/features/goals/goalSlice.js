...
//THUNK FUNCTIONS
//create new goal dispatched from goalForm
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createGoal.fulfilled, (state, action) => {
        ...
        console.log("create goal action: " + JSON.stringify(action.payload));
      })
      ...
      .addCase(getGoals.fulfilled, (state, action) => {
        ...
        console.log("get goal action: " + JSON.stringify(action.payload));
      })
